        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Command_CommandStatus_StatusId",
                        column: x => x.StatusId,
                        principalTable: "CommandStatus",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Command_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Article_Command_CommandId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Article_CommandId",
                table: "Article",
                column: "CommandId");

            migrationBuilder.CreateIndex(
                name: "IX_Command_StatusId",
                table: "Command",
                column: "StatusId");
